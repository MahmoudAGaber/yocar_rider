...
class _$OnReviewSubmittedImpl implements _OnReviewSubmitted {
  ...
  @override
  String toString() {
    return 'RateOrderEvent.onReviewSubmitted(orderId: $orderId, rating: $rating, comment: $comment, parameters: $parameters)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return onReviewSubmitted(orderId, rating, comment, parameters);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return onReviewSubmitted?.call(orderId, rating, comment, parameters);
  }
