...
class MobileLayoutDelegate extends MultiChildLayoutDelegate {
  ...
  final String cardLayoutId;
  final String actionButtonId;
  final String myLocationButtonId;

  MobileLayoutDelegate({
    required this.mapLayoutId,
    required this.cardLayoutId,
    required this.actionButtonId,
    required this.myLocationButtonId,
  });
