...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i19.HomeRepository>(
      () => _i20.HomeRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i19.HomeRepository>(
      () => _i21.HomeRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    ...
    gh.lazySingleton<_i26.NewOrderRepository>(
      () => _i27.NewOrderRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i26.NewOrderRepository>(
      () => _i28.NewOrderRepositoryMock(),
      registerFor: {_dev},
    );
    ...
    gh.lazySingleton<_i32.OrderPreviewRepository>(
      () => _i33.OrderPreviewRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i32.OrderPreviewRepository>(
      () => _i34.OrderPreviewRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i35.OrderRepository>(
      () => _i36.OrderRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i35.OrderRepository>(
      () => _i37.OrderRepositoryMock(),
      registerFor: {_dev},
    );
    ...
    gh.lazySingleton<_i41.ProfileRepository>(
      () => _i42.ProfileRepositoryProd(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i43.ProfileRepository>(
      () => _i44.ProfileRepositoryProd(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i43.ProfileRepository>(
      () => _i45.ProfileRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i41.ProfileRepository>(
    ...
    gh.lazySingleton<_i50.RedeemGiftCardRepository>(
      () => _i51.RedeemGiftCardRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i50.RedeemGiftCardRepository>(
      () => _i52.RedeemGiftCardRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    ...
    gh.lazySingleton<_i76.AuthBloc>(
        () => _i76.AuthBloc(gh<_i43.ProfileRepository>()));
    gh.lazySingleton<_i6.AuthRepository>(
    ...
    gh.lazySingleton<_i82.FavoriteDriversCubit>(
        () => _i82.FavoriteDriversCubit(gh<_i41.ProfileRepository>()));
    ...
    gh.lazySingleton<_i86.GeoDatasource>(
      () => _i88.GeoDatasourceImpl(gh<_i22.LocationDatasource>()),
      registerFor: {_dev},
    );
    ...
    gh.lazySingleton<_i96.ProfileBloc>(
        () => _i96.ProfileBloc(gh<_i41.ProfileRepository>()));
