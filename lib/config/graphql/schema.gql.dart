...
enum Enum$RiderWalletSortFields { id, currency, riderId, $unknown }
...
enum Enum$SavedPaymentMethodSortFields { id, riderId, $unknown }
...
enum Enum$DriverSortFields { id, $unknown }
